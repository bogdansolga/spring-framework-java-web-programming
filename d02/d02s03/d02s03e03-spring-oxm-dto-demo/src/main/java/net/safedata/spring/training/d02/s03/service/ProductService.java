package net.safedata.spring.training.d02.s03.service;

import net.safedata.spring.training.d02.s03.dto.ProductDTO;
import net.safedata.spring.training.domain.model.Product;
import net.safedata.spring.training.d02.s03.repository.ProductRepository;
...
public class ProductService {
    ...
    private Function<ProductDTO, Product> getDTOConverter() {
        return dto -> new Product(dto.getId(), dto.getProductName(), 230d);
    }
