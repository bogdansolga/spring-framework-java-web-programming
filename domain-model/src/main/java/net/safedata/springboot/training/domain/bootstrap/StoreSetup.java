package net.safedata.springboot.training.domain.bootstrap;

import net.safedata.springboot.training.domain.model.Discount;
import net.safedata.springboot.training.domain.model.Product;
import net.safedata.springboot.training.domain.model.Section;
import net.safedata.springboot.training.domain.model.Store;
import net.safedata.springboot.training.domain.model.StoreSection;
