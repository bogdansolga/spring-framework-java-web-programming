package net.safedata.spring.training.d03.s04.config;

import net.safedata.spring.training.d03.s04.model.Product;
import net.safedata.spring.training.d03.s04.service.ProductService;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "net.safedata.spring.training.d03.s04.repository")
