package net.safedata.springboot.training.complete.project;
...
import net.safedata.springboot.training.complete.project.repository.ProductRepository;
...
public class ProductService {
    ...
    public void update(final int id, final ProductDTO productDTO) {
        final Product product = getDTOConverter().apply(get(id));
