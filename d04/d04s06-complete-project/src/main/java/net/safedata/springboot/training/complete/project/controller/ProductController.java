package net.safedata.springboot.training.complete.project.controller;

import net.safedata.springboot.training.complete.project.dto.ProductDTO;
import net.safedata.springboot.training.complete.project.model.Product;
import net.safedata.springboot.training.complete.project.security.auth.HasManagerRole;
import net.safedata.springboot.training.complete.project.ProductService;
...
import static net.safedata.springboot.training.complete.project.security.auth.Roles.ADMIN_ROLE;
