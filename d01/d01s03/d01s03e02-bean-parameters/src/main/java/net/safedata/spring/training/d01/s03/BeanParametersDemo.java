package net.safedata.spring.training.d01.s03;

import net.safedata.spring.training.d01.s03.config.BeanParametersConfig;
import net.safedata.spring.training.d01.s03.service.ProductService;
...
public class BeanParametersDemo {
    ...
    public static void main(String[] args) {
        ...
        final ConfigurableApplicationContext configurableApplicationContext = buildApplicationContext();

        // retrieving a bean using Dependency Injection, not instantiating it (using new)
        final ProductService productService = configurableApplicationContext.getBean(ProductService.class);
